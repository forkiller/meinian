...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKITEM_SUCCESS = "查询自由行列表成功";
    public static final String QUERY_CHECKGROUP_SUCCESS = "查询跟团游列表成功";
    public static final String DELETE_SERMEAL_SUCCESS = "删除套餐游成功";
    public static final String EDIT_SERMEAL_SUCCESS = "编辑套餐游成功";
}
